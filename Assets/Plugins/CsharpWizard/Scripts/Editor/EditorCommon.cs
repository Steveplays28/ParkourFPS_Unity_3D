...
namespace Pinwheel.CsharpWizard
{
    public static class EditorCommon
    {
        ...
        public static Color linkColor = selectedItemColor;
        ...
        public static GUIStyle OddFlatButton
        {
            get
            {
                ...
                {
                    oddFlatButton = new GUIStyle(EditorStyles.label);
        ...
        public static GUIStyle EvenFlatButton
        {
            get
            {
                ...
                {
                    evenFlatButton = new GUIStyle(EditorStyles.label);
        ...
        public static GUIStyle SelectedFlatButton
        {
            get
            {
                ...
                {
                    selectedFlatButton = new GUIStyle(EditorStyles.label);
